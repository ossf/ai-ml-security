...
This committee interlocks with multiple groups to eliminate duplication and to
serve as the central place for collating any recommendations for using AI
securely ("security for AI" vision) and for using AI to improve security of
other OSS software products ("AI for security" vision).

Our [Mission, Vision, Strategy, and Roadmap (MVSR)](https://github.com/ossf/ai-ml-security/blob/main/mvsr.md) document lists significant interlocks and current plans.
